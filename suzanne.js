...
const ibl_url = `${assets_dir}/environments/${environ}/${environ}_ibl.ktx`;
const sky_small_url = `${assets_dir}/environments/${environ}/${environ}_skybox_tiny.ktx`;
const sky_large_url = `${assets_dir}/environments/${environ}/${environ}_skybox.ktx`;
const albedo_url = `${assets_dir}/models/albedo${albedo_suffix}.ktx`;
const ao_url = `${assets_dir}/models/ao${texture_suffix}.ktx`;
const metallic_url = `${assets_dir}/models/metallic${texture_suffix}.ktx`;
const normal_url = `${assets_dir}/models/normal${texture_suffix}.ktx`;
const roughness_url = `${assets_dir}/models/roughness${texture_suffix}.ktx`;
const filamat_url = `${assets_dir}/materials/textured.filamat`;
const filamesh_url = `${assets_dir}/models/monkey.filamesh`;
